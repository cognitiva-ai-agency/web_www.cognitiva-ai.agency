...
export default function Footer() {
  ...
  const stats = [
    { value: "500+", label: "Empresas Activas", icon: Users, trend: "+23%" },
    { value: "10M+", label: "Mensajes/mes", icon: MessageCircle, trend: "+45%" },
    { value: "99.9%", label: "Uptime SLA", icon: Activity, trend: "Estable" },
  ...
  return (
    <footer className="relative bg-[#000412] text-white overflow-hidden">
      ...
      {/* Sección superior con CTA épico */}
            ...
            <div className="relative rounded-3xl bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl border border-white/10 p-16 text-center">
              ...
              <div className="inline-block mb-8">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full blur-2xl opacity-60" 
                       style={{ animation: 'pulse 2s ease-in-out infinite' }} />
                  <div className="relative inline-flex items-center gap-3 px-8 py-4 rounded-full bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20">
                    <Zap className="h-5 w-5 text-cyan-400" style={{ animation: 'pulse 1s ease-in-out infinite' }} />
                    <span className="text-sm font-light text-cyan-300 tracking-wider">
                      TECNOLOGÍA DE VANGUARDIA • IA GENERATIVA • MACHINE LEARNING
                    </span>
                    <Bot className="h-5 w-5 text-cyan-400" style={{ animation: 'pulse 1.5s ease-in-out infinite' }} />
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-8">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                {/* Info de contacto con diseño mejorado */}
      ...
      {/* Footer bottom con diseño épico */}
      <div className="relative border-t border-white/5">
        ...
        <div className="container-padded py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            {/* Social links con efectos mejorados */}
