    ...
    >
      ...
      <div ref={ref} className="container-padded relative animate-in">
        ...
        <div className="relative">
          ...
          {/* Steps */}
          <ol className="relative grid lg:grid-cols-5 gap-8 lg:gap-4 max-w-sm mx-auto lg:max-w-none">
            {PROCESS_STEPS.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  {!isLast && (
                    <div className="lg:hidden absolute top-28 left-1/2 transform -translate-x-1/2 bottom-0 w-[2px] bg-gradient-to-b from-white/20 to-transparent" />
                  )}
                  ...
                  <div className="relative">
                    ...
                    <div className="relative mb-6 lg:mb-8 flex justify-center">
                      <div className="relative">
                        ...
                        <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                    ...
                    {/* Contenido del paso */}
                    <div className="relative rounded-3xl bg-gradient-to-br from-white/[0.06] to-white/[0.02] backdrop-blur-xl border border-white/10 p-6 lg:p-8 overflow-hidden transition-all duration-500 group-hover:translate-y-[-4px] group-hover:shadow-[0_30px_60px_rgba(99,102,241,0.25)] text-center">
